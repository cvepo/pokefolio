...
export default function ComparePage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const json = (await res.json()) as CompareSeriesResponse
      setData(json)
    } catch (e) {
  ...
  if (error) {
    return (
      <div className="p-6 md:p-8 max-w-[1400px] mx-auto space-y-4">
        ...
        <div className="border border-destructive/40 rounded-xl p-6 bg-card space-y-3">
          <p className="text-sm font-medium text-destructive">Couldn’t load compare data</p>
