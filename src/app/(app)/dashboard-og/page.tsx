...
/**
 * The original dashboard, kept for reference after the terminal rebuild took
 * over /dashboard. Deliberately NOT in the sidebar — reachable at
 * /dashboard-og by URL only. Left intact rather than deleted so the previous
 * presentation of the same numbers stays comparable.
 */
